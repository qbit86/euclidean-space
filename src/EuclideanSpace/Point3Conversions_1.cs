namespace EuclideanSpace
{
        ...
        where TTarget : INumberBase<TTarget>
    {
        ...
        /// <summary>
        /// Creates a new <see langword="Point3&lt;TTarget&gt;" /> instance with all components initialized to the components of the specified <paramref name="point" /> converted to <typeparamref name="TTarget" />.
        /// </summary>
        ...
        /// <returns>A new <see langword="Point3&lt;TTarget&gt;" /> with all components initialized to the components of <paramref name="point" /> converted to <typeparamref name="TTarget" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Creates a new <see langword="Point3&lt;TTarget&gt;" /> instance with all components initialized to the components of the specified <paramref name="vector" /> converted to <typeparamref name="TTarget" />.
        /// </summary>
        ...
        /// <returns>A new <see langword="Point3&lt;TTarget&gt;" /> with all components initialized to the components of <paramref name="vector" /> converted to <typeparamref name="TTarget" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Creates a new <see langword="Vector3&lt;TTarget&gt;" /> instance with all components initialized to the components of the specified <paramref name="point" /> converted to <typeparamref name="TTarget" />.
        /// </summary>
        /// <param name="point">The point whose components to convert to <typeparamref name="TTarget" />.</param>
        /// <typeparam name="TScalar">The type of the components of the input point.</typeparam>
        /// <returns>A new <see langword="Vector3&lt;TTarget&gt;" /> with all components initialized to the components of <paramref name="point" /> converted to <typeparamref name="TTarget" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
